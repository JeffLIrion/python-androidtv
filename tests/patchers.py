...
PATCH_PUSH = {
    KEY_PYTHON: patch("{}.{}.push".format(__name__, ADB_DEVICE_TCP_FAKE)),
    KEY_SERVER: patch("{}.{}.push".format(__name__, DEVICE_FAKE)),
}

PATCH_PULL = {
    KEY_PYTHON: patch("{}.{}.pull".format(__name__, ADB_DEVICE_TCP_FAKE)),

...
class TestFireTVSyncPython(unittest.TestCase):
    ...
    def test_state_detection(self):
        ...
        self.assertUpdate([True, True, 1, "com.amazon.tv.launcher", None, None, None],
                          (constants.STATE_IDLE, "com.amazon.tv.launcher", ["com.amazon.tv.launcher"], None))

        # Amazon Video
        self.assertUpdate([True, True, 1, constants.APP_AMAZON_VIDEO, 3, [constants.APP_AMAZON_VIDEO], None],
                          (constants.STATE_PLAYING, constants.APP_AMAZON_VIDEO, [constants.APP_AMAZON_VIDEO], None))

        self.assertUpdate([True, True, 1, constants.APP_AMAZON_VIDEO, 2, [constants.APP_AMAZON_VIDEO], None],
                          (constants.STATE_PAUSED, constants.APP_AMAZON_VIDEO, [constants.APP_AMAZON_VIDEO], None))

        self.assertUpdate([True, True, 1, constants.APP_AMAZON_VIDEO, 1, [constants.APP_AMAZON_VIDEO], None],
        ...
        self.assertUpdate([True, True, 2, constants.APP_AMAZON_VIDEO, 2, [constants.APP_AMAZON_VIDEO], None],
                          (constants.STATE_PAUSED, constants.APP_AMAZON_VIDEO, [constants.APP_AMAZON_VIDEO], None))

        self.assertUpdate([True, True, 5, constants.APP_AMAZON_VIDEO, 3, [constants.APP_AMAZON_VIDEO], None],
                          (constants.STATE_PLAYING, constants.APP_AMAZON_VIDEO, [constants.APP_AMAZON_VIDEO], None))

        self.assertUpdate([True, True, 5, constants.APP_AMAZON_VIDEO, 1, [constants.APP_AMAZON_VIDEO], None],
                          (constants.STATE_IDLE, constants.APP_AMAZON_VIDEO, [constants.APP_AMAZON_VIDEO], None))

        self.ftv._state_detection_rules = {constants.APP_AMAZON_VIDEO: [{'standby': {'media_session_state': 2}}]}
        self.assertUpdate([True, True, 2, constants.APP_AMAZON_VIDEO, None, [constants.APP_AMAZON_VIDEO], None],
                          (constants.STATE_IDLE, constants.APP_AMAZON_VIDEO, [constants.APP_AMAZON_VIDEO], None))

        # Firefox
        self.assertUpdate([True, True, 3, constants.APP_FIREFOX, 3, [constants.APP_FIREFOX], None],
                          (constants.STATE_PLAYING, constants.APP_FIREFOX, [constants.APP_FIREFOX], None))

        self.assertUpdate([True, True, 1, constants.APP_FIREFOX, 3, [constants.APP_FIREFOX], None],
                          (constants.STATE_IDLE, constants.APP_FIREFOX, [constants.APP_FIREFOX], None))

        # Hulu
        self.assertUpdate([True, True, 4, constants.APP_HULU, 3, [constants.APP_HULU], None],
                          (constants.STATE_PLAYING, constants.APP_HULU, [constants.APP_HULU], None))

        self.assertUpdate([True, True, 2, constants.APP_HULU, 3, [constants.APP_HULU], None],
                          (constants.STATE_PAUSED, constants.APP_HULU, [constants.APP_HULU], None))

        self.assertUpdate([True, True, 1, constants.APP_HULU, 3, [constants.APP_HULU], None],
                          (constants.STATE_IDLE, constants.APP_HULU, [constants.APP_HULU], None))

        # Jellyfin
        self.assertUpdate([True, True, 2, constants.APP_JELLYFIN_TV, 3, [constants.APP_JELLYFIN_TV], None],
                          (constants.STATE_PLAYING, constants.APP_JELLYFIN_TV, [constants.APP_JELLYFIN_TV], None))

        self.assertUpdate([True, True, 4, constants.APP_JELLYFIN_TV, 3, [constants.APP_JELLYFIN_TV], None],
                          (constants.STATE_PAUSED, constants.APP_JELLYFIN_TV, [constants.APP_JELLYFIN_TV], None))

        # Netfilx
        self.assertUpdate([True, True, 1, constants.APP_NETFLIX, 3, [constants.APP_NETFLIX], None],
                          (constants.STATE_PLAYING, constants.APP_NETFLIX, [constants.APP_NETFLIX], None))

        self.assertUpdate([True, True, 1, constants.APP_NETFLIX, 2, [constants.APP_NETFLIX], None],
                          (constants.STATE_PAUSED, constants.APP_NETFLIX, [constants.APP_NETFLIX], None))

        self.assertUpdate([True, True, 1, constants.APP_NETFLIX, 1, [constants.APP_NETFLIX], None],
                          (constants.STATE_IDLE, constants.APP_NETFLIX, [constants.APP_NETFLIX], None))

        # Plex
        self.assertUpdate([True, True, 1, constants.APP_PLEX, 3, [constants.APP_PLEX], None],
                          (constants.STATE_PLAYING, constants.APP_PLEX, [constants.APP_PLEX], None))

        self.assertUpdate([True, True, 2, constants.APP_PLEX, 3, [constants.APP_PLEX], None],
                          (constants.STATE_PAUSED, constants.APP_PLEX, [constants.APP_PLEX], None))

        self.assertUpdate([True, True, 1, constants.APP_PLEX, 1, [constants.APP_PLEX], None],
                          (constants.STATE_IDLE, constants.APP_PLEX, [constants.APP_PLEX], None))

        # Sport 1
        self.assertUpdate([True, True, 3, constants.APP_SPORT1, 3, [constants.APP_SPORT1], None],
                          (constants.STATE_PLAYING, constants.APP_SPORT1, [constants.APP_SPORT1], None))

        self.assertUpdate([True, True, 2, constants.APP_SPORT1, 3, [constants.APP_SPORT1], None],
                          (constants.STATE_PAUSED, constants.APP_SPORT1, [constants.APP_SPORT1], None))

        self.assertUpdate([True, True, 1, constants.APP_SPORT1, 3, [constants.APP_SPORT1], None],
                          (constants.STATE_IDLE, constants.APP_SPORT1, [constants.APP_SPORT1], None))

        # Spotify
        self.assertUpdate([True, True, 1, constants.APP_SPOTIFY, 3, [constants.APP_SPOTIFY], None],
                          (constants.STATE_PLAYING, constants.APP_SPOTIFY, [constants.APP_SPOTIFY], None))

        self.assertUpdate([True, True, 1, constants.APP_SPOTIFY, 2, [constants.APP_SPOTIFY], None],
                          (constants.STATE_PAUSED, constants.APP_SPOTIFY, [constants.APP_SPOTIFY], None))

        self.assertUpdate([True, True, 1, constants.APP_SPOTIFY, 1, [constants.APP_SPOTIFY], None],
        ...
        self.assertUpdate([True, True, 2, constants.APP_WAIPU_TV, 1, [constants.APP_WAIPU_TV], None],
                          (constants.STATE_PAUSED, constants.APP_WAIPU_TV, [constants.APP_WAIPU_TV], None))

        self.assertUpdate([True, True, 1, constants.APP_WAIPU_TV, 1, [constants.APP_WAIPU_TV], None],
                          (constants.STATE_IDLE, constants.APP_WAIPU_TV, [constants.APP_WAIPU_TV], None))

        # Unknown app
        self.assertUpdate([True, True, 1, 'unknown', 3, ['unknown'], None],
                          (constants.STATE_PLAYING, 'unknown', ['unknown'], None))

        self.assertUpdate([True, True, 1, 'unknown', 2, ['unknown'], None],
        ...
        self.assertUpdate([True, True, 1, 'unknown', None, ['unknown'], None],
                          (constants.STATE_PLAYING, 'unknown', ['unknown'], None))

        self.assertUpdate([True, True, 2, 'unknown', None, ['unknown'], None],
                          (constants.STATE_PAUSED, 'unknown', ['unknown'], None))
